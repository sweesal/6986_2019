...
public class DriveBaseAdvanced extends Subsystem {
  ...
  public static Timer distanceTimer;
  public static Timer turningTimer;
...
public void CalculateDistance(){
  ...
  if(distanceTimer.get()>.02){

    leftDistance = leftDistance + leftMpS;
    rightDistance =  rightDistance + rightMpS;
    
    prevLeftVelocity = leftMpS;
    System.out.print(leftMpS);
    System.out.print(prevLeftVelocity);
    prevRightVelocity = rightMpS;
    //double distance = (leftDistance + rightDistance)/2;

    leftAccel = (leftMpS - prevLeftVelocity) /0.02;
    rightAccel = (rightMpS - prevRightVelocity) /0.02;
    System.out.println(leftAccel);
